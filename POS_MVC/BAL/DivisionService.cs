...
namespace Service.Service
{
    public class DivisionService : IDivisionService
    {
        ...
        //public Division CreateObject(int departmentId, string Code, string Name, string Description, DEPARTMENTService _departmentService)
        //{
        ...
        public Division SoftDeleteObject(Division division, EmployeeService _employeeService)
        {
