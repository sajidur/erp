...
namespace Service.Service
{
    public class EmployeeEducationService : IEmployeeEducationService
    {
        ...
        public EmployeeEducation CreateObject(EmployeeEducation employeeEducation, EmployeeService _employeeService)
        {
        ...
        public EmployeeEducation UpdateObject(EmployeeEducation employeeEducation, EmployeeService _employeeService)
        {
