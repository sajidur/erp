...
namespace Service.Service
{
    public class SalaryEmployeeService : ISalaryEmployeeService
    {
        ...
        public SalaryEmployee CreateObject(SalaryEmployee salaryEmployee, EmployeeService _employeeService, 
            ...
            if(_validator.ValidCreateObject(salaryEmployee, _employeeService, this)) 
            {
               ...
               // if (!salaryEmployee.Errors.Any())
                //{
                    ...
                    IList<SalaryStandardDetail> details = _salaryStandardDetailService.GetObjectsByTitleInfoId(1);
        ...
        public SalaryEmployee UpdateObject(SalaryEmployee salaryEmployee, EmployeeService _employeeService)
        {
