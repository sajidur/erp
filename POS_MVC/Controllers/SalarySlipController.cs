...
namespace WebView.Controllers
{
    ...
    public class SalarySlipController : Controller
    {
        ...
        //                     model.SalarySign,
        //                     model.FormulaId,
        //                     FirstCode = model.Formula.SalaryItem.Code,
        //                     model.Formula.FormulaOp,
        //                     SecondCode = model.Formula.IsSecondValue ? SqlFunctions.StringConvert(model.Formula.SecondValue,20,4).Trim() : model.Formula.SalaryItem1.Code,
        //                     model.HasMinValue,
        //                     model.MinValue,
        //                     model.HasMaxValue,
        //                     model.MaxValue,
        ...
        public dynamic GetInfoDetail(int Id)
        {
            ...
            return Json(new
            {
                ...
                model.SalarySign,
                model.FormulaId,
                FirstCode = model.Formula.SalaryItem1.Code,
                model.Formula.FormulaOp,
                SecondCode = model.Formula.IsSecondValue ? model.Formula.SecondValue.ToString() : model.Formula.SalaryItem.Code,
