...
namespace Validation.Validation
{
    public class SalaryEmployeeValidator : ISalaryEmployeeValidator
    {
        ...
        public SalaryEmployee VHasEmployee(SalaryEmployee salaryEmployee, EmployeeService _employeeService)
        {
        ...
        public bool ValidCreateObject(SalaryEmployee salaryEmployee, EmployeeService _employeeService, ISalaryEmployeeService _salaryEmployeeService)
        {
        ...
        public bool ValidUpdateObject(SalaryEmployee salaryEmployee, EmployeeService _employeeService, ISalaryEmployeeService _salaryEmployeeService)
        {
