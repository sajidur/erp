<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportViewer.aspx.cs" Inherits="RiceMill_MVC.Report.Viewer.ReportViewer" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" ValidateRequestMode="Disabled" AsyncPostBackTimeout="36000" EnablePartialRendering="true" ></asp:ScriptManager>
